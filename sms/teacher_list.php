...
<nav class="navbar navbar-default">
  <div class="container">
   ...
   <li><a href="#"><span class="glyphicon glyphicon-user"></span><?php echo "Hello ".$_SESSION['login_user']." ."; ?></a></li>
...
<thead>
<tr>
<th>SN</th><th>Name</th><th>Username</th><th>Password</th><th>Mobile</th><th>Email</th><th>Address</th><th>Gender</th><th>Birthday</th><th>Hobby</th><th>Comments</th><th>Action</th><th></th>
</tr>
</thead>
<tbody>
<?php
$sql ="SELECT * FROM `login_detail` WHERE user='teacher'";
...
echo ('<td colspan="1"><a href="view.php?id=' .$id. '">view</a></td>');
echo ('<td colspan="1"><a href="delete.php?id=' .$id. '">Delete</a></td>');
echo "</tr>";
}?>
</tbody>
</table>
